		...
		<div id="container">
			<div id="content">
				...
				<div class="homepageLinkContainer">
					...
					<div class="homepageLink" data-tooltip="Calcolo Pesi Carrelli" onclick="gotopath('calcoloPesiCarrelli.php')">
						<i class="fad fa-print"></i>
						<div>Etichette Carrelli</div>
					</div>
					<div class="homepageLink" data-tooltip="Dati Salvagnini" onclick="gotopath('datiSalvagnini.php')">
						<i class="fad fa-database"></i>
						<div>Dati Salvagnini</div>
					</div>
				</div>
